package com.cuncisboss.runningapp.ui.viewmodels
...
import com.cuncisboss.runningapp.repositories.MainRepository
import com.cuncisboss.runningapp.util.SortType
...
class MainViewModel @ViewModelInject constructor(private val mainRepository: MainRepository): ViewModel() {
    ...
    private val runSortedByTimeMillis = mainRepository.getAllRunsSortedByTimeInMillis()
    ...
    init {
        ...
        runs.addSource(runSortedByTimeMillis) { result ->
    ...
    fun sortRuns(sortType: SortType) = when (sortType) {
        ...
        SortType.RUNNING_TIME -> runSortedByTimeMillis.value?.let { runs.value = it }
